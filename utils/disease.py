disease_dic = {
    ...
    'Apple___Black_rot': """ <b>Crop</b>: Apple <br/>Disease: Black Rot<br/>
        ...
        <br/>2. Consider planting disease-resistant apple tree varieties, as they are less susceptible to black rot.
        
        <br/>3. Remove infected plant material from the area.
        <br/>4. Apply fungicides to infected apple trees as soon as symptoms of black rot appear.
